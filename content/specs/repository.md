...
*See the [Data Repositories Guide](../guides/data-repos) document for a higher-level introduction.*
...
Adding optional fields to Commit and MST Node object may or may not result in a repo format version change. Changing the MST "fanout", or any changes to the current MST fields, would be a full repo version change.
