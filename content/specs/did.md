...
In the context of atproto, only two DID methods are currently supported:
...
DID identifiers do not generally have a maximum length restriction. In the context of atproto there is an initial hard limit of 2 KBytes.
