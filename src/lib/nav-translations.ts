...
const navTranslations: Record<string, Record<string, string>> = {
  ja: {
    ...
    '/guides/about-oauth': 'OAuthについて',
    '/guides/permission-requests': 'パーミッションリクエスト',
    '/guides/permission-sets': 'パーミッションセット',
    '/guides/oauth-patterns': 'OAuthパターン',
    ...
    '/guides/installing-lexicons': 'Lexiconでの開発',
  ...
  ko: {
    ...
    // Link titles (from ko.mdx header.title exports)
    ...
    '/articles/atproto-ethos': 'atproto의 기본 이념',
    '/guides/faq': 'FAQ',
    '/guides/auth': '인증',
    '/guides/sdk-auth': 'SDK 인증',
    '/guides/about-oauth': 'OAuth에 대하여',
    '/guides/permission-requests': '권한 요청',
    '/guides/permission-sets': '권한 집합',
    ...
    '/guides/backfilling': '백필',
    '/guides/feeds': '피드',
    '/guides/lexicon': 'Lexicon',
    '/guides/installing-lexicons': 'Lexicon 개발',
    '/guides/publishing-lexicons': 'Lexicon 게시',
    '/guides/lexicon-style-guide': 'Lexicon 스타일 가이드',
    '/guides/images-and-video': '이미지와 동영상',
    '/guides/blob-lifecycle': 'blob 생명주기',
