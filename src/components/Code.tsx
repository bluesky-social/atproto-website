  ...
  return (
    <div className="group dark:bg-white/2.5">
      ...
      <div className="relative">
        <pre className="overflow-x-auto p-4 text-xs text-black dark:text-white">
          {children}
        </pre>
...
export function CodeGroup({
  ...
  let containerClassName =
    'my-6 overflow-hidden rounded-2xl bg-zinc-50 dark:bg-zinc-900 dark:ring-1 dark:ring-white/10'
  let header = (
