...
function CodePanelHeader({ tag, label }: { tag?: string; label?: string }) {
  ...
  return (
    <div className="flex h-9 items-center gap-2 border-y border-b-white/7.5 border-t-transparent bg-slate-900 bg-white/2.5 px-4 dark:border-b-white/5 dark:bg-white/1">
      {tag && (
...
export function CodeGroup({
  ...
  let containerClassName =
    'my-6 overflow-hidden rounded-2xl bg-slate-50 dark:bg-slate-900 dark:ring-1 dark:ring-white/10 max-w-[var(--code-container-width)]'
  let header = (
