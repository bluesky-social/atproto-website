...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  const isHome =
    ...
    pathname.endsWith('/the-atmosphere')
  const isAtmosphere = pathname.endsWith('/the-atmosphere')
  ...
  return (
    <SectionProvider sections={[]} /* fallback to be overridden */>
      <div className={clsx('h-full', !isHome && 'lg:ml-72 xl:ml-72')}>
        ...
        <div className={clsx('relative flex h-full flex-col', !isAtmosphere && 'pt-14')}>
