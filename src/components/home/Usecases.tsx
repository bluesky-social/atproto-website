...
export function Usecases({ wide, locale }: { wide?: boolean; locale?: string }) {
    ...
    <div className="flex flex-col gap-4">
      ...
      >
        <Card className="flex-1" href="/guides/statusphere-tutorial">
          <DotPatternContainer className="px-6 py-4" fade>
            ...
            <CardTitle>{t('Create an App')}</CardTitle>
            <CardParagraph>
              {t('Tap into the shared Atmosphere network to create your next app.')}
            </CardParagraph>
            <CardCTA>{t('LEARN MORE')}</CardCTA>
          </DotPatternContainer>
        </Card>
        <Card className="flex-1" href="/guides/bot-tutorial">
          <DotPatternContainer className="px-6 py-4" fade>
            <UserIcon className="mb-6 mt-2 size-12" strokeWidth="0.6" />
            <CardTitle>{t('Build an Agent')}</CardTitle>
            <CardParagraph>
              {t('Listen to the firehose for mentions and reply to users automatically.')}
            </CardParagraph>
            <CardCTA>{t('LEARN MORE')}</CardCTA>
          </DotPatternContainer>
        </Card>
        <Card className="flex-1" href="/guides/custom-feed-tutorial">
          <DotPatternContainer className="px-6 py-4" fade>
            ...
            <CardTitle>{t('Write an Algorithm')}</CardTitle>
            <CardParagraph>
              {t('Use simple rules or advanced ML to create custom feeds.')}
            </CardParagraph>
            <CardCTA>{t('LEARN MORE')}</CardCTA>
          </DotPatternContainer>
        </Card>
        ...
        <Card className="flex-1" href="/guides/tutorials#o-auth-with-go">
          <DotPatternContainer className="px-6 py-4" fade>
            <KeyIcon
              ...
              strokeWidth="0.6"
            />
            <CardTitle>{t('Login with user-owned identities')}</CardTitle>
            <CardParagraph>
              {t("Usernames are just domains. We're @atproto.com!")}
            </CardParagraph>
            <CardCTA>{t('LEARN MORE')}</CardCTA>
          </DotPatternContainer>
        </Card>
      ...
      <div className="hidden md:block">
        <CTAButton href="/guides/tutorials#o-auth-with-go">
          ...
          <CTAButtonTitle title={t('Login with user-owned identities')} subtitle={t("Usernames are just domains. We're @atproto.com!")} />
        </CTAButton>
      </div>
    </div>
  )
