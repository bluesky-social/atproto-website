...
The conversation that became [npmx](https://npmx.dev) started with [a question on Bluesky asking about people's frustrations with JavaScript packaging](https://bsky.app/profile/danielroe.dev/post/3md3cmrg56k2r). Daniel Roe, Matias Capeletto, and Zeu join us to talk about how a shared frustration turned into one of the most active community-led projects on atproto — and what the first two weeks of a thousand pull requests looked like from the inside.
