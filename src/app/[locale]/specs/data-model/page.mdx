...
Best practices for validating and limiting the size and structure of generic atproto data are described in a [Data Validation guide](/guide/data-validation), which is not formally part of this specification.
