...
- `transition:email`: gives access to read your email address
    - `com.atproto.server.getSession` will expose `email`, `emailAuthFactor` and `emailConfirmed` in it's response
