...
<Note>
You may want to change your metadata filepath from `/client-metdata.json` to `/oauth-client-metadata.json` to have your brand domain display on the authorize page, rather than a URL string:
