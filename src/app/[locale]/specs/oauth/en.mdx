...
<Note>
As of August 2025, a more granular permission system is available for use, announced and described [here](https://github.com/bluesky-social/atproto/discussions/4118). This mechanism has not yet been formally specified, but the design is considered stable.
</Note>
