...
<Note>
If you have been using `client-metadata.json` rather than `oauth-client-metadata.json`, you can make this change to have your domain display on the authorize page, rather than a URL string:
</Note>
...
<Note>
As of August 2025, a more granular permission system is available for use, announced and described [here](https://github.com/bluesky-social/atproto/discussions/4118). The design is considered stable, although it has not yet been formally documented in this specification.
</Note>
