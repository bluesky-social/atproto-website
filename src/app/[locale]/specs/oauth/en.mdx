...
- for "untrusted" public clients, overall session lifetime should be limited to 2 weeks, and the lifetime of individual refresh tokens should be limited to 2 days
