...
<video src="/blog/report-based-moderation/queue-create-flow.mp4" controls muted playsInline className="rounded-lg" />
...
<video src="/blog/report-based-moderation/action-report-and-bulk-close.mp4" controls muted playsInline className="rounded-lg" />
