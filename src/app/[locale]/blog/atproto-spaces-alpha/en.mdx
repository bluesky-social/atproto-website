...
Apart from the space itself, things should feel familiar. Users have [DIDs](https://atproto.com/specs/did). Users host their data in their repositories. Records are JSON and defined by Lexicons. Applications sync repos and build views of the data.
