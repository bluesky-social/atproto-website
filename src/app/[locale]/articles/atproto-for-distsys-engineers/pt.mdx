...
O AT Protocol é a tecnologia desenvolvida na [Bluesky](https://bsky.app) para redes sociais abertas. Neste artigo, exploraremos o AT Proto da perspectiva da engenharia de backend distribuída. {{className: 'lead'}}
