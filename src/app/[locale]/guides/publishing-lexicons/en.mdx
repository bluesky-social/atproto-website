...
Lexicons are published to a PDS like any other AT record. They are resolved using DNS TXT records to link [NSID namespaces](/specs/nsid) to repositories, so that when you retrieve a Lexicon like `com.atproto.example,` atproto SDKs will know to [look for an identity at `atproto.com`](https://pds.ls/at://did:plc:6msi3pj7krzih5qxqtryxlzw/com.atproto.lexicon.schema) and retrieve the Lexicon from there.
