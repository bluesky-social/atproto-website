...
For CRUD permissions on additional elements of the Bluesky Lexicon, you would want to add these scopes as needed:
- `repo:app.bsky.feed.*`  — for feed operations (posts, reposts, likes)
- `repo:app.bsky.graph.*` — for social graph operations (follows, blocks, mutes)
