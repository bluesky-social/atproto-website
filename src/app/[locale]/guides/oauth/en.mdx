...
| --- | --- | --- | --- | --- | --- |
| [cookbook/oauth-react-native-expo](https://github.com/bluesky-social/cookbook/tree/main/oauth-react-native-expo#readme) | TypeScript | @atproto/oauth-client-expo | Mobile App (no backend) | No | No (requires hosted client metadata) |
