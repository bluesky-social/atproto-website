...
TypeScriptフィードジェネレーターの例を提供しています。[チュートリアル](/guides/custom-feed-tutorial)を参照してください。 
...
いくつかの機械学習機能を追加して、フィードアルゴリズムをさらに調整することもできます。例については、[tri-bsky-feed](https://tangled.org/cuducos.me/tri-bsky-feed)を参照してください。
