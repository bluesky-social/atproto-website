...
We also have a [more minimal example](https://tangled.org/strings/did:plc:vmt7o7y6titkqzzxav247zrn/3mbujziyniw22) using the new [lex](https://www.npmjs.com/package/@atproto/lex) SDK and [tap](https://www.npmjs.com/package/@atproto/tap) TypeScript library.
