...
For getting started with OAuth, see [About OAuth](/guides/oauth-patterns). For understanding permission scopes, see [Permission Sets](/guides/permission-sets). For the full specification, see the [OAuth spec](/specs/oauth).
