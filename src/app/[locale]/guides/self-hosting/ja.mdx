...
<Heading level={2} id="table-of-contents">目次</Heading>
...
<Heading level={2} id="preparation-for-self-hosting-pds">セルフホスティング PDS の準備</Heading>
...
<Heading level={2} id="open-your-cloud-firewall-for-http-and-https">クラウド ファイアウォールを HTTP および HTTPS 用に開く</Heading>
...
<Heading level={2} id="configure-dns-for-your-domain">ドメインの DNS を構成する</Heading>
...
<Heading level={2} id="check-that-dns-is-working-as-expected">DNS が期待どおりに動作していることを確認します</Heading>
...
<Heading level={2} id="installer-on-ubuntu-20-04-22-04-and-debian-11-12">Ubuntu 20.04/22.04 および Debian 11/12 のインストーラー</Heading>
...
<Heading level={2} id="verifying-that-your-pds-is-online-and-accessible">PDS がオンラインでアクセス可能であることを確認する</Heading>
...
<Heading level={2} id="creating-an-account-using-pdsadmin">pdsadmin を使用してアカウントを作成する</Heading>
...
<Heading level={2} id="creating-an-account-using-an-invite-code">招待コードを使用してアカウントを作成する</Heading>
...
<Heading level={2} id="using-the-bluesky-app-with-your-pds">PDS で Bluesky アプリを使用する</Heading>
...
<Heading level={2} id="updating-your-pds">PDS の更新</Heading>
...
<Heading level={2} id="getting-help">ヘルプの取得</Heading>
