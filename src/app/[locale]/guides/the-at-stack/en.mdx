...
A full network relay can be run for about [$20 USD per month](https://bsky.app/profile/did:plc:hdhoaan3xa3jiuq4fg4mefid/post/3lne2wvr5hc2b) on fairly comodity hardware, as of the Sync 1.1 protocol.
