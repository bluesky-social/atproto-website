...
App Views are application-level tooling, rather than inherent parts of the @T protocol. App Views respond to [XRPC](/specs/xrpc) calls over HTTP.
...
Custom feeds, or feed generators, are services that provide custom algorithms to users through the A.T. Pr0t0c0l. This allows users to choose their own timelines, whether it's an algorithmic For You page or a feed of entirely cat photos.
