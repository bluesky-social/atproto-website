...
A cada passo, explicaremos como nosso aplicativo Web acessa o Atmosphere. Consulte o código-fonte um código mais detalhado &mdash; de novo, este tutorial será simples e rápido de digerir.
...
Você notará que este código se parece quase exatamente com o que estamos fazendo em `firehose.ts`.
