...
<Link href="TODO" className="not-prose flex items-center gap-2 bg-blue-100 dark:bg-blue-950 dark:text-white px-4 py-3 text-base rounded-lg hover:underline">
...
Nosso repositório é um aplicativo Web regular. Estamos renderizando nosso servidor HTML como se fosse 1999. Também temos um banco de dados SQLite que estamos gerenciando com [Kysley](https://kysely.dev/).

Nossa pilha inicial:

- Typescript
- NodeJS servidor web ([express](https://expressjs.com/))
- SQLite banco de dados ([Kysley](https://kysely.dev/))
