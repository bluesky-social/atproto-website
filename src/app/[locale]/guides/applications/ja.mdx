...
<Heading level={2} id="step-1-starting-with-our-expressjs-app">ステップ 1. ExpressJS アプリから始める</Heading>
...
<Heading level={2} id="step-2-signing-in-with-oauth">ステップ 2. OAuth でサインイン</Heading>
...
<Heading level={2} id="step-3-fetching-the-users-profile">ステップ 3. ユーザーのプロファイルを取得する</Heading>
...
<Heading level={2} id="step-4-reading-writing-records">ステップ 4. レコードの読み取りと書き込み</Heading>
...
<Heading level={2} id="step-5-creating-a-custom-status-schema">ステップ 5. カスタムの「ステータス」スキーマの作成</Heading>
...
<Heading level={2} id="step-6-listening-to-the-firehose">ステップ 6. ファイアホースをリッスン</Heading>
...
<Heading level={2} id="step-7-listing-the-latest-statuses">ステップ 7. 最新のステータスを一覧表示する</Heading>
...
<Heading level={2} id="step-8-optimistic-updates">ステップ 8. 楽観的更新</Heading>
...
<Heading level={2} id="thinking-in-at-proto">AT Proto で考える</Heading>
...
- Atmosphere に公開するレコードの [Lexicon](https://atproto.com/guides/lexicon) スキーマを設計します。
