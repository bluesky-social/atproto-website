...
ATプロトコルをすぐに理解できるように、ここでは簡単な内容に留めます。各ステップについて、詳細情報へのリンクがあります。 {{className: 'lead'}}
...
<Heading level={2} id="step-6-listening-to-the-firehose">ステップ6. ファイアホースをリッスン</Heading>
...
<Heading level={2} id="thinking-in-at-proto">ATプロトコル的に考える</Heading>
