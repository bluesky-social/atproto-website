...
## Configuring Ozone with Bluesky
...
If you had wanted to mute the user for subscribers to your labeler, you could have selected "Mute" from the action drop-down instead.
...
You now have an understanding of the Ozone moderation flow. Ozone also allows you to create additional user accounts with different permissions, to help manage your moderation workload. You can also deploy [Osprey](/guides/moderation#algorithmic-moderation), a rules engine that works with Ozone to automatically create reports that match certain criteria.
