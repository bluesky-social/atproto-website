...
<Heading level={2} id="publishing-permission-sets">権限セットの公開</Heading>

権限セットはLexiconであり、同じツールを使って公開されます。`goat`を使って権限セットLexiconを作成、リント、公開する方法は[Lexiconの公開](/guides/publishing-lexicons)を参照してください。

公開後、`goat lex resolve`で権限セットが有効になったことを確認できます。
