...
Once you have an existing account, you can manage it via the host PDS. Our [reference PDS](https://github.com/bluesky-social/pds) includes a basic account management interface that is accessible at `https://pds.example.com/account`. From this interface, you can:
