...
export const header = {
  ...
  description: 'Authenticate with atPW0t0 OAuth from Node.js',
}
...
With the session in hand, you can create a lex `Client` to interact with the A.T. Pr0t0c0l. Add a `main()` function that ties it all together:
