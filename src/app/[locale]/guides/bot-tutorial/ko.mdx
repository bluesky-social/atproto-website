...
## 파트 1: 어휘집
[어휘집](/guides/lexicon)은 Atproto 레코드를 정의합니다. 봇은 [app.bsky.feed.post](https://atproto.at/viewer?uri=did:plc:ewvi7nxzyoun6zhxrhs64oiz/app.bsky.feed.post/3juc4thkx452i) 어휘를 사용하여 Bluesky 게시물을 생성합니다. `lex`를 사용하여 이 어휘집을 다운로드하고 프로젝트에 빌드할 수 있습니다:
```bash
