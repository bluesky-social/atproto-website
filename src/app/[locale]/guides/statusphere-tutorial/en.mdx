...
Now, in another terminal, clone the [indigo](https://github.com/bluesky-social/indigo) repo to run a Tap server locally:
...
Stop and restart your app with `pnpm dev` again, and you'll start seeing statuses from other users on the network!
