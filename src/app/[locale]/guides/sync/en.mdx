...
There are many ways of synchronizing and streaming AT data. You can use [Jetstream](/guides/jetstream) to stream real-time updates, or [Backfill](/guides/backfilling) the data that already exists on the network.
