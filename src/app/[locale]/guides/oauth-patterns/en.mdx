...
The following libraries handle the OAuth flow, including [DPoP](/guides/oauth-advanced#understanding-d-po-p), token refresh, and session management.
...
- [@fujocoded/authproto](https://github.com/FujoWebDev/fujocoded-plugins/tree/main/astro-authproto) ([npmjs](https://www.npmjs.com/package/@fujocoded/authproto)) - Community implementation for Astro apps
...
1. Your app redirects the user to their PDS's authorization endpoint with your requested scopes
...
- [OAuth Patterns](/guides/oauth-advanced) (advanced topics like DPoP)
