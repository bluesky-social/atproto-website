...
現在、DID 方式のいずれも当社の基準を完全に満たしていません。 **そのため、私たちは[did-web](https://w3c-ccg.github.io/did-method-web/)と、私たちが作成した[DID Placeholder](https://github.com/bluesky-social/did-method-plc)という一時的な方法をサポートすることを選択しました。** 新しいソリューションが登場するにつれて、この状況は進化していくと予想されます。ons が出現します。
