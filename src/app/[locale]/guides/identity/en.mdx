...
<DescriptionList>
  <Description title="Handles">Handles are DNS names. They are resolved using the `com.atproto.identity.resolveHandle` XRPC method and should be confirmed by a matching entry in the DID document. Details in the <a href="/specs/handle">Handle specification</a>.</Description>
  <Description title="DIDs">DIDs are an emerging <a href="https://www.w3.org/TR/did-core/">W3C standard</a> for providing stable & secure IDs. They are used as stable, canonical IDs of users. Details of how they are used in AT Protocol in the <a href="/specs/did">DID specification</a>.</Description>
...
When we started the project, none of the DID methods met our standards fully. **Therefore, we chose to support [did-web](https://w3c-ccg.github.io/did-method-web/), and a novel method we've created called [DID PLC](https://github.com/bluesky-social/did-method-plc).**
