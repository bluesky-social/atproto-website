...
This section is aimed at developers building applications on AT Protocol. TK TK TK
...
To implement OAuth in your application, refer to [OAuth patterns](/guides/oauth-patterns) for common use cases, and the [Scopes](/guides/scopes) guide for understanding permission models. If you are building a smaller app or bot, you may also consider using [SDK authentication](/guides/sdk-auth) with app passwords.
