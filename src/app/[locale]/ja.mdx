...
<ImageCard image={WebWithoutWallsPng} href="https://www.youtube.com/watch?v=F1sJW6nTP6E" title="壁のないウェブ - React Universe 2024 での講演" tag="Talk" description="React Universe Conf 2024 で Dan Abramov が発表した AT プロトコルの紹介" />

<ImageCard image={DotMediaInterviewPng} href="https://flipboard.video/w/ophhJTECuL7fcBNbUitV3q" title="Bluesky の Jay Graber 氏とともに、アイデンティティを再び中心に据える" tag="Interview" description="ジェイ・グレーバー氏とFlipboard CEOのマイク・マッキュー氏による、ソーシャルをWebに近づけることについてのインタビュー。" />
