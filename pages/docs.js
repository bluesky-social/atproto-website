    ...
    <div className="mb-8">
      {pages.map((page, pageIdx) => (
        <Link key={page.href} href={page.href}>
          <a
            className="relative flex items-center px-6 py-6 border border-gray-300 rounded-xl mb-4 focus:outline-none focus:border-blue-500 hover:border-blue-500 block text-left w-full"
          >
