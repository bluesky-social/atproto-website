...
export function Sidebar({ navigation, current }) {
  return  (
    <div className="hidden relative lg:block bg-default pb-4 w-[208px] rounded-lg">
          ...
          <a
            className={classNames(
              item.href === current
                ...
                : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-gray-100',
